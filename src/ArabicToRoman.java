...
/**
 * Handles conversions of Arabic numbers to Roman numbers.
 */
public class ArabicToRoman {
    ...
    /**
     * Validates if parsed input is a valid Arabic number to proceed with the conversion to Roman number.
     * The converter only accepts integers between 1 and 1000.
     *
    ...
    /**
     * Returns the range number where parsed num belongs to.
    ...
    /**
     * Returns the range type where parsed num belongs to.
     * Number has "upper" range if it's first digit is 4 or 9. These two are generated by subtracting.
     * Other ones aren't generated by subtracting, so they belong to "lower" range.
     */
